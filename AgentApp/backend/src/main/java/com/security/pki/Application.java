...
public class Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User admin = new User(1, "neki@gmail.com", passwordEncoder.encode("123"), adminRole, true, 0, Timestamp.from(Instant.now()));
		userRepository.save(admin);

		User user = new User(2, "user@gmail.com", passwordEncoder.encode("123"), userRole, true, 0, Timestamp.from(Instant.now()));
