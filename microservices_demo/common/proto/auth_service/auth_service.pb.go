...
func (x *AddUser) GetSurname() string {
	if x != nil {
		return x.Surname
	}
	return ""
...
var file_auth_service_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x0d, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x41,
	0x6c, 0x6c, 0x55, 0x73, 0x65, 0x72, 0x73, 0x22, 0x32, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x41, 0x6c,
	...
	0x55, 0x73, 0x65, 0x72, 0x52, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x22, 0x50, 0x0a, 0x04, 0x55,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x73, 0x75, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x6f, 0x0a,
	0x07, 0x41, 0x64, 0x64, 0x55, 0x73, 0x65, 0x72, 0x12, 0x1a, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x72,
	...
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x73, 0x75, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x32, 0x89,
	0x01, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x41,
	0x0a, 0x06, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x12, 0x11, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e,
	0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x55, 0x73, 0x65, 0x72, 0x73, 0x1a, 0x14, 0x2e, 0x61, 0x75,
	...
	0x73, 0x12, 0x37, 0x0a, 0x0a, 0x41, 0x64, 0x64, 0x4e, 0x65, 0x77, 0x55, 0x73, 0x65, 0x72, 0x12,
	0x0d, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x41, 0x64, 0x64, 0x55, 0x73, 0x65, 0x72, 0x1a, 0x0a,
	0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x22, 0x0e, 0x82, 0xd3, 0xe4, 0x93,
	0x02, 0x08, 0x22, 0x06, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x73, 0x42, 0x3a, 0x5a, 0x38, 0x67, 0x69,
...
var file_auth_service_proto_goTypes = []interface{}{
	(*GetAllUsers)(nil),    // 0: auth.GetAllUsers
	(*GetAllResponse)(nil), // 1: auth.GetAllResponse
	(*User)(nil),           // 2: auth.User
	(*AddUser)(nil),        // 3: auth.AddUser
}
var file_auth_service_proto_depIdxs = []int32{
	2, // 0: auth.GetAllResponse.users:type_name -> auth.User
	0, // 1: auth.AuthService.GetAll:input_type -> auth.GetAllUsers
	3, // 2: auth.AuthService.AddNewUser:input_type -> auth.AddUser
	1, // 3: auth.AuthService.GetAll:output_type -> auth.GetAllResponse
	2, // 4: auth.AuthService.AddNewUser:output_type -> auth.User
